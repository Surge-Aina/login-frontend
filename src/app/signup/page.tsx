 ...
 * Description:
 * - Renders a user signup form.
 * - Collects email, password, and user role.
 * - Sends form data to the backend signup API.
...
export default function SignupPage() {
   ...
   * - Sends signup data (email, password, role) to backend API.
   * - Redirects to login on success or shows error message.
   */
